  ...
  return (
    <Container maxWidth="lg" sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      <Typography variant="h6" gutterBottom sx={{ mt: '4px' }}>
        Effortlessly organize items with flexible categories, brands, attributes, and sets. Customize pricing lists and levels for efficient service and inventory management. Tailor your product definitions for optimal business efficiency
      </Typography>
